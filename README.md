...
### _Curated list of the best FOSS (free open source software) apps! - Instead of putting multiple apps in a single category, I chose two of the best apps for each after testing and making sure that you get your privacy back._

# CONTRIBUTION

To help out with this project:
-   Find more  **foss** apps and suggest them.
-   Give updates about the repositories of the apps.
-   Fork this repo.
...
| -------------- | 
- [ASSISTANT](#Asisstant)
- [CONNECTED DEVICE MANAGER](#Connected-Device-Manger)
...
- [TOOLS](#Tools)
- [VIDEO MANIPULATION](#Image-Manipulation)
...
- ### Calculator
    - ##### [Opencalc](https://f-droid.org/packages/com.darkempire78.opencalculator/)
    - ##### [yetcalc](https://f-droid.org/packages/yetzio.yetcalc/)
- ### Dictionary
    - ##### [FreeDictionaryApp](https://f-droid.org/packages/io.github.yamin8000.owl/)
    - ##### [Notification Dictionary](https://f-droid.org/packages/com.xtreak.notificationdictionary/)
- ### Downloader
    - ##### [Seal](https://f-droid.org/packages/com.junkfood.seal/)
    - ##### [Fetchit](https://f-droid.org/packages/com.tharunbirla.fetchit/)
- ### File Sharing
    - ##### [Local Send](https://f-droid.org/packages/org.localsend.localsend_app/)
    - ##### [Snapdrop & Pairdrop](https://f-droid.org/packages/com.fmsys.snapdrop/)
- ### File Manager
...
- ### Keyboard
    - ##### [Anysoft Keyboard](https://f-droid.org/packages/com.menny.android.anysoftkeyboard/)
    - ##### [Heliboard](https://f-droid.org/packages/helium314.keyboard/)
- ### Translation
    - ##### [Simply Mobile Translate](https://f-droid.org/packages/com.simplytranslate_mobile/)
    - ##### [DeepL](https://f-droid.org/packages/com.example.deeplviewer/)
- ### Voice Recorder
...
- ### Calendar
    - ##### [Fossify](https://f-droid.org/packages/org.fossify.calendar/)
    - ##### [Birday](https://f-droid.org/packages/com.minar.birday/)
- ### Weather
    - ##### [Bura](https://f-droid.org/packages/com.davidtakac.bura/)
    - ##### [Rain](https://apt.izzysoft.de/fdroid/index/apk/com.yoshi.rain)
...
- ### RSS Reader
    ...
    - ##### [Readrops](https://f-droid.org/packages/com.readrops.app/)
- ### Spotify
    - ##### [Harmony Music](https://f-droid.org/packages/com.anandnet.harmonymusic/)
    - ##### [Spotube](https://f-droid.org/packages/oss.krtirtho.spotube/)
- ### Torrent
    - ##### [Libre Torrent](https://f-droid.org/packages/org.proninyaroslav.libretorrent/)
...
- ### Video Player
    ...
    - ##### [Next Player](https://f-droid.org/packages/dev.anilbeesetti.nextplayer/)

## Social Media
- ### Reddit
    - ##### [Infinity](https://apt.izzysoft.de/fdroid/index/apk/ml.docilealligator.infinityforreddit.patreon/)
    - ##### [Stealth](https://f-droid.org/packages/com.cosmos.unreddit/)
- ### Sigal
    - ##### [Molly](https://github.com/mollyim/mollyim-android/)
    - ##### [Signal you](https://github.com/nekorubu/Signal-You/)   
- ### Twitch
    - ##### [Frosty](https://github.com/tommyxchow/frosty/)
    - ##### [Xtra](https://f-droid.org/packages/com.github.andreyasadchy.xtra/)
- ### Twitter
    - ##### [Squaker](https://f-droid.org/packages/org.ca.squawker/)
...
- ### Browser Sync
    - ##### [Xbrowsersync](https://f-droid.org/packages/com.xBrowserSync.android/)

## Security
- ### 2 Factor Authentication
    - ##### [Aegis](https://f-droid.org/packages/com.beemdevelopment.aegis/)
    - ##### [Ente Auth](https://f-droid.org/packages/io.ente.auth/)
- ### AD Blocker
    - ##### [ADaway](https://f-droid.org/packages/org.adaway/)
    - ##### [DNSnet](https://f-droid.org/packages/dev.clombardo.dnsnet/)
- ### Firewall
    - ##### [Karma](https://f-droid.org/packages/net.stargw.fok/)
    - ##### [Net Guard](https://f-droid.org/packages/eu.faircode.netguard/)
- ### Password Manager
...
- ### Security
    - ##### [Exodus](https://f-droid.org/packages/org.eu.exodus_privacy.exodusprivacy/)
    - ##### [Pcapdroid](https://f-droid.org/packages/com.emanuelef.remote_capture/)
- ### VPN
    - ##### [Proton](https://f-droid.org/packages/ch.protonvpn.android/)
    - ##### [Mullvad](https://f-droid.org/packages/net.mullvad.mullvadvpn/)


## Personalisation
- ### Icon Pack
    - ##### [Lawnicons](https://apt.izzysoft.de/fdroid/index/apk/app.lawnchair.lawnicons/)
    - ##### [Delta](https://f-droid.org/packages/website.leifs.delta.foss/)
- ### Launcher
    - ##### [Lawnchair](https://apt.izzysoft.de/fdroid/index/apk/app.lawnchair/)
    - ##### [Kvaesitso](https://f-droid.org/packages/de.mm20.launcher2.release/)

## Productivity
- ### Assistant
    - ##### [Dicio Assistant](https://f-droid.org/packages/org.stypox.dicio/)
- ### Connected Device Manager
    - ##### [Gadget Bridge](https://f-droid.org/packages/nodomain.freeyourgadget.gadgetbridge/)
- ### Home Automation
    - ##### [Home Assistant](https://f-droid.org/packages/io.homeassistant.companion.android.minimal/)
- ### Text to Speech
...
## Utilities
- ### ADB Tools
    - ##### [Ashell You](https://f-droid.org/packages/in.sunilpaulmathew.ashell/)
    - ##### [Logcat Reader](https://f-droid.org/packages/com.dp.logcatapp/)
- ### Backup
    - ##### [Neo Backup](https://f-droid.org/packages/com.machiav3lli.backup/)
    - ##### [DataBackup](https://f-droid.org/packages/com.xayah.databackup.foss/)
- ### Battery
    - ##### [Wattz](https://f-droid.org/packages/dubrowgn.wattz/)
    - ##### [Saver Tuner](https://f-droid.org/packages/s1m.savertuner/)
- ### Music Recognition
    - ##### [Audire](https://apt.izzysoft.de/fdroid/index/apk/com.alexmercerind.audire/)
...
- ### Remote Desktop
    - ##### [RustDesk](https://f-droid.org/packages/com.carriez.flutter_hbb/)
- ### Root & Recovery
    - ##### [TWRP](https://github.com/TeamWin/Team-Win-Recovery-Project)
    - ##### [Magisk](https://f-droid.org/packages/com.topjohnwu.magisk/)
- ### Syncronisation
    - ##### [Syncthing Fork](https://f-droid.org/packages/com.github.catfriend1.syncthingandroid/)
    - ##### [Owncloud](https://f-droid.org/packages/com.owncloud.android/)
- ### System Cleaner
    - ##### [SD Maid 2/SE - System Cleaner](https://f-droid.org/packages/eu.darken.sdmse/)
- ### Terminal Emulator
    - ##### [Termux](https://f-droid.org/packages/com.termux/)
    - ##### [ConnectBot](https://f-droid.org/packages/org.connectbot/)
- ### Tools
    - ##### [Canta](https://f-droid.org/packages/org.samo_lego.canta)
    - ##### [Key Mapper](https://f-droid.org/packages/io.github.sds100.keymapper/)
- ### Video Manipulation
    - ##### [Open Video Editor](https://f-droid.org/packages/net.sourceforge.opencamera/)
- ### URL Manipulation
    - ##### [URLcheck](https://f-droid.org/packages/com.trianguloy.urlchecker/)
    - ##### [Untracker](https://f-droid.org/packages/me.zhanghai.android.untracker)
- ### Email Alias
    - ##### [Addy.io](https://f-droid.org/packages/host.stjin.anonaddy)
    - ##### [Simple Login](https://f-droid.org/packages/io.simplelogin.android.fdroid)
